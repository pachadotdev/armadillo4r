.PHONY: check-cran check-cran-extra check-% clean install revdep docs
...
revdep:
	$(MAKE) install
	@Rscript --vanilla -e 'pak::pkg_install("pachadotdev/leontief")'
	@Rscript --vanilla -e 'pak::pkg_install("pachadotdev/economiccomplexity")'
