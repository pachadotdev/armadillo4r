...
# Register cpp as an alias for C++ syntax highlighting
knitr::knit_engines$set(cpp = function(options) {
  # Just return the code as-is for syntax highlighting
...
If you vendor `armadillo4r`, Armadillo options on C++ side can be configured via editing the file `include/armadillo/config.hpp`.
