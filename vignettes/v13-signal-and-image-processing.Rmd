---
title: "13 - Signal and image processing"
output:
...
vignette: >
  %\VignetteIndexEntry{13 - Signal and image processing}
...
* By default, the function uses an internal FFT algorithm based on KISS FFT. With vendoring, it is possible to
  use the FFTW3 library for faster execution by modifying the armadillo4r header to:
