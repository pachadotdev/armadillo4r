local({
  ...
  res1 <- matrix1_(a)
  expect_true(is.double(res1))
  expect_equal(dim(res1), c(2, 2))

  res2 <- matrix2_(a)
  expect_true(is.complex(res2))
  ...
  res17 <- fill1_(a)
  expect_true(is.double(res17))
  expect_equal(dim(res17), c(2, 2))

  res18 <- imbue1_(a)
  expect_true(is.double(res18))
