...
armadillo4r has different internals, even when the goal is the same, and it
aims to:
...
This is expanded in our article [armadillo4r: An R package to use the Armadillo C++ library](https://dx.doi.org/10.1016/j.softx.2025.102087).
