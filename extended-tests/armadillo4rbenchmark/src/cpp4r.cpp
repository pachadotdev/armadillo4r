...
// bench-armadillo4r.cpp
doubles_matrix<> add_two_cpp4r(const doubles_matrix<>& a, const doubles_matrix<>& b);
extern "C" SEXP _armadillo4rbenchmark_add_two_cpp4r(SEXP a, SEXP b) {
  BEGIN_CPP4R
...
extern "C" SEXP _armadillo4rbenchmark_add_four_cpp4r(SEXP a, SEXP b, SEXP c, SEXP d) {
  BEGIN_CPP4R
...
extern "C" SEXP _armadillo4rbenchmark_multiply_four_cpp4r(SEXP a, SEXP b, SEXP c, SEXP d) {
  BEGIN_CPP4R
...
extern "C" SEXP _armadillo4rbenchmark_submatrix_manipulation_cpp4r(SEXP a, SEXP b) {
  BEGIN_CPP4R
...
extern "C" SEXP _armadillo4rbenchmark_multi_operation_cpp4r(SEXP a, SEXP b, SEXP c) {
  BEGIN_CPP4R
...
static const R_CallMethodDef CallEntries[] = {
    {"_armadillo4rbenchmark_add_four_cpp4r",               (DL_FUNC) &_armadillo4rbenchmark_add_four_cpp4r,               4},
    {"_armadillo4rbenchmark_add_two_cpp4r",                (DL_FUNC) &_armadillo4rbenchmark_add_two_cpp4r,                2},
    {"_armadillo4rbenchmark_multi_operation_cpp4r",        (DL_FUNC) &_armadillo4rbenchmark_multi_operation_cpp4r,        3},
    {"_armadillo4rbenchmark_multiply_four_cpp4r",          (DL_FUNC) &_armadillo4rbenchmark_multiply_four_cpp4r,          4},
    {"_armadillo4rbenchmark_submatrix_manipulation_cpp4r", (DL_FUNC) &_armadillo4rbenchmark_submatrix_manipulation_cpp4r, 2},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_armadillo4rbenchmark(DllInfo* dll){
