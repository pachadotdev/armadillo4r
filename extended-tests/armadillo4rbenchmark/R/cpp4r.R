...
add_two_cpp4r <- function(a, b) {
	.Call(`_armadillo4rbenchmark_add_two_cpp4r`, a, b)
}

#' @title Add Four Matrices
#' @export
add_four_cpp4r <- function(a, b, c, d) {
	.Call(`_armadillo4rbenchmark_add_four_cpp4r`, a, b, c, d)
}

#' @title Multiply Four Matrices
#' @export
multiply_four_cpp4r <- function(a, b, c, d) {
	.Call(`_armadillo4rbenchmark_multiply_four_cpp4r`, a, b, c, d)
}

#' @title Submatrix Manipulation
#' @export
submatrix_manipulation_cpp4r <- function(a, b) {
	.Call(`_armadillo4rbenchmark_submatrix_manipulation_cpp4r`, a, b)
}

#' @title Multi-Operation Expression
#' @export
multi_operation_cpp4r <- function(a, b, c) {
	.Call(`_armadillo4rbenchmark_multi_operation_cpp4r`, a, b, c)
}
